# Django settings for opal_test project.
import commands
import os
import sys
...
SECRET_KEY = '%8hp2rkiw--3$27^xbfa)t@c(-kqw(=!5cd+(5))l(brpy5y)$'
...
ROOT_URLCONF = 'opal_test.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'opal_test.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('opal_test.migrations', 'opal_test.tests',
                            'opal_test.local_settings',
